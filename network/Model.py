...
class AttentionEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.fc2 = nn.Linear(config['ROI_size']*config['linear_size'], config['embedding_size'])        
